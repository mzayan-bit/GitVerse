...
export class DocumentationAgent implements Agent {
  public readonly id = 'documentationagent';
  public readonly name = 'Documentation Agent';
  public readonly description =
    'Analyzes and reports on documentation aspects of the repository.';
  ...
  public async execute(context: AgentContext): Promise<Finding[]> {
    ...
    findings.push({
      ...
      title: 'Potential Documentation Issue',
