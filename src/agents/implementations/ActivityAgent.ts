...
export class ActivityAgent implements Agent {
  public readonly id = 'activityagent';
  public readonly name = 'Activity Agent';
  public readonly description =
    'Analyzes and reports on activity aspects of the repository.';
  ...
  public async execute(context: AgentContext): Promise<Finding[]> {
    ...
    findings.push({
      ...
      title: 'Potential Activity Issue',
