...
export class ContributorAgent implements Agent {
  public readonly id = 'contributoragent';
  public readonly name = 'Contributor Agent';
  public readonly description =
    'Analyzes and reports on contributor aspects of the repository.';
  ...
  public async execute(context: AgentContext): Promise<Finding[]> {
    ...
    findings.push({
      ...
      title: 'Potential Contributor Issue',
